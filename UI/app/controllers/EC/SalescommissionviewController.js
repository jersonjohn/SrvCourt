...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            ...
            formHeader: 'Real Time Commission :: Sales Commission Monthly View',
            zModel: {},
            zData: {},
            ngResource: $resource,
            ngLocation: $location,
        ...
        grp.LoadTransactionDetaildata = function (options) {
            ...
            for (var i = 0; i < options.length; i++) {
                ...
                options[i].id = i;
                options[i].AmountValue = "";
                options[i].HappyValue = happyValue;
                options[i].SadValue = sadValue;
    ...
    app.register.controller('SalescommissionviewController', zc);
