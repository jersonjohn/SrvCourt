...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            ...
            formHeader: 'Real Time Commission :: Service Commission Monthly View',
            zModel: {},
            zData: {},
            ngResource: $resource,
            ngLocation: $location,
        ...
        grp.LoadTransactionDetaildata = function (options) {
            ...
            for (var i = 0; i < options.length; i++) {
                ...
                var Amount = "$" + options[i].Service_Comm;
    ...
    app.register.controller('ServicecommissionviewController', zc);
