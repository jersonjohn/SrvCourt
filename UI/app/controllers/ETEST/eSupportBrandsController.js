...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        var vm = this;
         ...
         $scope.group = {
            name: 'eSupportDepts',
            gridColumnFields: zSrv_InputCustom.formFields({name:'eSupportBrands'}),
            gridResourceURL: zSrv_ResourceServer.getURL('eSupportBrandsUrl'),
		    ...
		    ngScope : $scope,
            resourceURL: zSrv_ResourceServer.getURL('eSupportBrandsUrl'),
            modelResource: null,
    ...
    app.register.controller('eSupportBrandsController', zc);
