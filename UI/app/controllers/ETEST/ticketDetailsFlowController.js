...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        var vm = this;
         ...
         $scope.group = {
            ...
            gridColumnFields: zSrv_InputCustom.formFields({name:'ticketDetailsFlow'}),
            gridResourceURL: zSrv_ResourceServer.getURL('eSupportTktDetailsUrl'),//eSupportHomeUrl,
			
			parentReferenceField: 'TicketId',

            createModelURL: '/createtktdetails',
            editModelURL: '/edittktdetails',
            listModelURL: '/eSupportTktdetails',
		    ...
		    ngScope : $scope,
            resourceURL: zSrv_ResourceServer.getURL('eSupportTktDetailsUrl'), //eSupportHomeUrl,
            modelResource: null,
            cookieGridState: 'listTicketDetails_Grid1',
            dept: 'IT',
    ...
    app.register.controller('ticketDetailsFlowController', zc);
