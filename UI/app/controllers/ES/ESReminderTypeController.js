...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
        name: 'eApptReminderType',
        gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptReminderType' }),

        gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrReminderTypeUrl'),
        ...
        createModelURL: '/createeApptReminderType',
        editModelURL: '/editeApptReminderType',
        listModelURL: '/listeApptReminderType',
		...
		ngScope: $scope,
        resourceURL: zSrv_ResourceServer.getURL('eApptReminderTypeUrl'),
        modelResource: null,
        cookieGridState: 'listReminderTypeCtrl_Grid1',
    ...
    */
    ...
    app.register.controller('eApptReminderTypeController', zc);
