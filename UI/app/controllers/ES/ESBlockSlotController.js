...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
        name: 'eApptBlockSlot',
        gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptBlockSlot' }),

        gridResourceURL: zSrv_ResourceServer.getURL('eApptBlockSlotUrl'),
        ...
        createModelURL: '/createeApptBlockSlot',
        editModelURL: '/editeApptBlockSlot',
        listModelURL: '/listeApptBlockSlot',
		...
		ngScope: $scope,
        resourceURL: zSrv_ResourceServer.getURL('eApptBlockSlotUrl'),
        modelResource: null,
    ...
    */
    ...
    app.register.controller('eApptBlockSlotController', zc);
