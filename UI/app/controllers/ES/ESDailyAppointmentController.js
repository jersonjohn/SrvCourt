...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            ...
            formHeader: 'Outlet Daily Schedule-Consultant',
        ...
        $scope.callPopupWait = function (ev, consultantId, date, time, row, col,customerId) {

            $scope.message = "";
            var appointments = $scope.getWaitAppointments(row, col);

            ////dont show same customer
            //for (var app in appointments) {
            //    if (appointments[app].customerId == customerId) {
            //        appointments.splice(app, 1);
            //    }
            //}
