...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
       ...
       $scope.group = {
            name: 'eApptDisplaySetting',
            gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptDisplaySetting' }),

            gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrDisplaySettingUrl'),
            ...
            createModelURL: '/createeApptDisplaySetting',
            editModelURL: '/editeApptDisplaySetting',
            listModelURL: '/listeApptDisplaySetting',
            ...
            formHeader: 'Master Display Setting',
            fields: [],
            buttonTop: [],
            buttons: [],
            gridOptions: {},
		    ...
		    ngScope: $scope,
            resourceURL: zSrv_ResourceServer.getURL('eApptMtrDisplaySettingUrl'),
            modelResource: null,
            cookieGridState: 'listDisplaySettingCtrl_Grid1',
    ...
    app.register.controller('eApptDisplaySettingController', zc);
