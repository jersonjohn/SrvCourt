...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            name: 'eApptPfDaySetting',
            gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptPfDaySetting' }),

            gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrPreferDaySettingUrl'),
            ...
            createModelURL: '/createeApptPfDaySetting',
            editModelURL: '/editeApptPfDaySetting',
            listModelURL: '/listeApptPfDaySetting',
            ...
            formHeader: 'Master Prefer Day Setting',
            fields: [],
            buttonTop: [],
            buttons: [],
            gridOptions: {},
            ...
            ngScope: $scope,
            resourceURL: zSrv_ResourceServer.getURL('eApptMtrPreferDaySettingUrl'),
            modelResource: null,
            cookieGridState: 'listpfDaySettingCtrl_Grid1',
    ...
    app.register.controller('eApptPfDaySettingController', zc);
