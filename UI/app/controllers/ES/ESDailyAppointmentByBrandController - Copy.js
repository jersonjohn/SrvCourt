...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.OnChangeCustomerId = function () {
            ...
            zSrv_InputCustom.httpGet('http://192.168.1.33:5013/api/getCustomerByAesId/' + Customer_AesId).then(function (respCustomer) {
        ...
        $scope.callUpdateAppointmentPopup = function (ev, customerId, customerName, appid) {
            ...
            zSrv_InputCustom.httpGet('http://192.168.1.33:5013/api/getAppointmentDetails/' + appid).then(function (appointment) {
        ...
        $scope.callAddAppointmentPopup = function (ev, consultantId,date,time) {
        ...
        $scope.callPopup = function (ev, customerId, customerName, appid, consultantId,date,time) {
            ...
            mg.showModal($scope, ev, view, false).then(function (answer) {
                ...
                switch (answer) {
                    ...
                    case "new": $scope.callAddAppointmentPopup(ev, consultantId,date,time);
                        break;
        ...
        //    if ($scope.gridDataModel[row][col].block[0].Status == "ACTIVE" || $scope.gridDataModel[row][col].block[0].Status == "") {
        //        currentElement.attr('bgcolor', 'lightgrey');
        //        $scope.gridDataModel[row][col].block[0].Status == "INACTIVE";

        //        var view = "scripts/app/views/eAppointment/zDailyApptReserveSlotView.html";
        //        var ev = null;
        //        mg.showModal($scope, ev, view, false).then(function (answer) {
        ...
        //        });
        //    }
        //    if ($scope.gridDataModel[row][col].block[0].Status == "INACTIVE") {
