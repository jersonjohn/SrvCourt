...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            name: 'eApptSetting',
            gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptSetting' }),
            ...
            createModelURL: '/ccreateeApptSlotSetting',
    ...
    app.register.controller('eApptSettingController', zc);
