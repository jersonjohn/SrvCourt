...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            name: 'eApptAccessSetting',
            gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptAccessSetting' }),

            gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrAccessSettingUrl'),
            ...
            createModelURL: '/createeApptAccessSetting',
            editModelURL: '/editeApptAccessSetting',
            listModelURL: '/listeApptAccessSetting',
            ...
            formHeader: 'User Access Setting',
            fields: [],
            buttonTop: [],
            buttons: [],
            gridOptions: {},
		    ...
		    ngScope: $scope,
            resourceURL: zSrv_ResourceServer.getURL('eApptMtrAccessSettingUrl'),
            modelResource: null,
            cookieGridState: 'listAccessSettingCtrl_Grid1',
    ...
    app.register.controller('eApptAccessSettingController', zc);
