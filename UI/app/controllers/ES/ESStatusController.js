...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
        name: 'eApptStatus',
        gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptStatus' }),

        gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrApptStatusUrl'),
        ...
        createModelURL: '/createeApptStatus',
        editModelURL: '/editeApptStatus',
        listModelURL: '/listeApptStatus',
		...
		ngScope: $scope,
		resourceURL: zSrv_ResourceServer.getURL('eApptMtrApptStatusUrl'),
        modelResource: null,
        cookieGridState: 'listStatusCtrl_Grid1',
    ...
    */
    ...
    app.register.controller('eApptStatusController', zc);
