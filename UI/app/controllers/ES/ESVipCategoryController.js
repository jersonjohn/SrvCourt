...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
        name: 'eApptVipCategory',
        gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptVipCategory' }),

        gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrVipCategoryUrl'),
        ...
        createModelURL: '/createeApptVipCategory',
        editModelURL: '/editeApptVipCategory',
        listModelURL: '/listeApptVipCategory',
		...
		ngScope: $scope,
        resourceURL: zSrv_ResourceServer.getURL('eApptMtrVipCategoryUrl'),
        modelResource: null,
        cookieGridState: 'listVipCategoryCtrl_Grid1',
    ...
    */
    ...
    app.register.controller('eApptVipCategoryController', zc);
