...
define(['app'], function (app) {
    ...
    var zc = function ($scope, $http, $resource, $window, $location, $route, $routeParams, zSrv_ResourceServer, zSrv_InputCustom,
        ...
        $scope.group = {
            ...
            gridColumnFields: zSrv_InputCustom.formFields({ name: 'eApptBrandSetting' }),

            gridResourceURL: zSrv_ResourceServer.getURL('eApptMtrBrandSettingUrl'),
            ...
            createModelURL: '/createeApptBrandSetting',
            editModelURL: '/editeApptBrandSetting',
            listModelURL: '/listeApptBrandSetting',
            ...
            formHeader: 'Brand Level Setting',
            fields: [],
            buttonTop: [],
            buttons: [],
            gridOptions: {},
		    ...
		    ngScope: $scope,
            resourceURL: zSrv_ResourceServer.getURL('eApptMtrBrandSettingUrl'),
            modelResource: null,
            cookieGridState: 'listBrandSettingCtrl_Grid1',
    ...
    app.register.controller('eApptBrandSettingController', zc);
