...
.controller("accountCtrl", ['$scope', '$rootScope', '$resource', '$window', '$location', '$route', '$routeParams', 'zSrv_OAuth2', 'zSrv_ResourceServer', 'zSrv_InputCustom', 'uiGridConstants',
...
//            ngCookies: $cookies
        ...
        //    $location.path($scope.group.addUserCollectionModelURL + "/" + model[$scope.group.indexKey]);
        //}
