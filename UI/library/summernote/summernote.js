...
(function (factory) {
      ...
      return $.Deferred(function (deferred) {
        $.extend(new FileReader(), {
          onload: function (e) {
            ...
            console.log("Inside SummerNote JS Library Image URL : "+dataURL);
          },
          onerror: function () {
  ...
  var Editor = function (context) {
    ...
    this.insertImagesOrCallback = function (files) {
      ...
      console.log("insertImagesOrCallback is fired ");
      ...
      return $.Deferred(function (deferred) {
        ...
        ui.onDialogShown(self.$dialog, function () {
          ...
          $imageUrl.on('keyup paste', function () {
              ...
              console.log("Image Url , Debugging from summernote.js Lib :"+url);
